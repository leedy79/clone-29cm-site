...
const Board = () => {
    ...
    const [boardList, setBoardList] = useState([
        { no: "1", title: '상품은 언제 배송이 되나요?', description: '어제부터 기다렸는데 아직 배송이 안됐어요.', viewCount: 1 },
        { no: "2", title: '사이즈가 작아요', description: '색상은 비슷한것 같은데 사이즈가 많이 작았어요. ', viewCount: 2 },
        { no: "3", title: '옷감이 설명과 달라요', description: '재질이 다른것 같아요.', viewCount: 1 },
    ]);
